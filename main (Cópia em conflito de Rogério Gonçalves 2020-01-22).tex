...
\include{pretextual/listaabreviaturas} % usando glossaries
...
\include{capitulos/cap-conceitos} % Esse capítulo e nome é apenas uma sugestão.
\include{capitulos/cap-trabalhos-relacionados} % Esse capítulo e nome é apenas uma sugestão.
